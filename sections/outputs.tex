\section{Outputs}
  ...
  \footnote{SE-S05 - Burn up charts created helped to keep this project in specific time constraints and when the project would be completed.}
  \footnote{SE-K06 - This shows how metrics can be gathered around the development lifecycle to track project progress and estimate finish dates.}
  ...
  \footnote{SE-K06 - This shows how metrics can be gathered an used to monitor live software.}
