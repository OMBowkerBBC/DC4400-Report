...
\noindent Amazon Web Services. (2024n) \textit{What is AWS CloudFormation?} [online]. Available at \url{https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/Welcome.html} (accessed on 4th March 2024).
\vspace{0.2cm}
...
\noindent Atlassian. (2024) \textit{How to conduct a successful sprint retrospective} [online]. Available at \url{https://www.atlassian.com/team-playbook/plays/retrospective} (accessed on 4th March 2024).
\vspace{0.2cm}
