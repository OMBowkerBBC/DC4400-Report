...
\noindent Grossman, D. (2023) \textit{A Sophomoric* Introduction to Shared-Memory Parallelism and Concurrency} [online]. Available at \url{https://homes.cs.washington.edu/~djg/teachingMaterials/spac/sophomoricParallelismAndConcurrency.pdf} (accessed on 26th February 2024).
\vspace{0.2cm}
